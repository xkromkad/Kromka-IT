...
export const companyCooperations: CompanyCooperation[] = [
  ...
  {
    name: 'Farnosť Nová Lesná',
    url: 'https://novalesna.farnost.sk',
    logo: '/icons/companies/novalesna_farnost.png',
    description: {
      sk: 'Rímskokatolícka farnosť Nová Lesná. Spravujem obsah farského webu.',
      en: 'Roman Catholic Parish of Nová Lesná. I manage the content of the parish website.',
    },
  },
];
    ...
    },
    {
      ...
      entries: [
        ...
        },
        {
          label: 'WinUI 3',
          description:
            '3-dňové školenie pod vedením Prof. Veikko Krypczyk z nemeckého školiaceho strediska',
    ...
    },
    {
      ...
      entries: [
        ...
        },
        {
          label: 'WCAG',
          description:
            'Interné školenia tvorby bezbarierového webu na ministerstve informatizácie Slovenskej republiky',
        },
      ],
    },
    {
      ...
      entries: [
        {
          label: 'Tvorba webu 5',
          description:
            'Kurz Tvorba, programovanie webstránok V. – jQuery, interaktivita a úvod do JavaScriptu v školiacom stredisku',
        ...
        },
        {
          label: 'Tvorba webu 4',
          description:
            'Kurz Tvorba, programovanie webstránok IV. – responzívny dizajn, media pravidlá, flex a grid rozloženie v školiacom stredisku',
          url: 'https://www.itlearning.sk',
          urlLabel: 'IT Learning Slovakia',
        },
        {
          label: 'Tvorba webu 3',
          description:
            'Kurz Tvorba, programovanie webstránok III. – expert HTML a CSS, pokročilé selektory, médiá a formuláre v školiacom stredisku',
          url: 'https://www.itlearning.sk',
          urlLabel: 'IT Learning Slovakia',
        },
        {
          label: 'MS SQL',
          description:
            'Kurz Microsoft SQL Server pre vývojárov III. – programovanie databázy v školiacom stredisku',
          url: 'https://www.itlearning.sk',
          urlLabel: 'IT Learning Slovakia',
        },
        {
          label: 'Bootstrap',
          description:
            'Kurz Bootstrap I. pre začiatočníkov – responzívny HTML, CSS a JS framework v školiacom stredisku',
          url: 'https://www.itlearning.sk',
          urlLabel: 'IT Learning Slovakia',
        },
      ],
    },
    {
      ...
      entries: [
        ...
        },
        {
          label: 'Vzdelávanie',
          description:
            'Kurzy zamerané na metodiku vzdelávania mládeže v informatike a príprava vzdelávacích materiálov v medzinárodnej škole programovania',
          url: 'https://slovakia.alg.academy/svk',
    ...
    },
    {
      ...
      entries: [
        ...
        },
        {
          label: 'WCAG',
          description:
            'Internal web accessibility training at the Ministry of Investments, Regional Development and Informatisation of the Slovak Republic',
        },
      ],
    },
    {
      ...
      entries: [
        {
          label: 'Web Dev 5',
          description:
            'Course: Web Programming V. – jQuery, interactivity and introduction to JavaScript at',
          url: 'https://www.itlearning.sk',
          urlLabel: 'IT Learning Slovakia',
        },
        {
          label: 'Web Dev 4',
          description:
            'Course: Web Programming IV. – responsive design, media queries, flexbox and grid at',
          url: 'https://www.itlearning.sk',
          urlLabel: 'IT Learning Slovakia',
        },
        {
          label: 'Web Dev 3',
          description:
            'Course: Web Programming III. – expert HTML & CSS, advanced selectors, media and forms at',
          url: 'https://www.itlearning.sk',
          urlLabel: 'IT Learning Slovakia',
        },
        {
        ...
        },
        {
          label: 'Bootstrap',
          description:
            'Course: Bootstrap I. for beginners – responsive HTML, CSS & JS framework at',
          url: 'https://www.itlearning.sk',
          urlLabel: 'IT Learning Slovakia',
        },
      ],
    },
    {
      ...
      entries: [
        ...
        },
        {
          label: 'Teaching',
          description:
            'Courses on youth IT education methodology and preparation of teaching materials at the international coding school',
          url: 'https://slovakia.alg.academy/svk',
          urlLabel: 'Algorithmics',
        },
      ],
  ...
  sk: [
    {
      ...
      type: 'Web',
      description:
        'Aplikácia na sledovanie zdravia a pohody domácich králikov. Denné záznamy, monitorovanie hmotnosti, plánovanie liekov a vedenie veterinárnych návštev s exportom do PDF.',
      longDescription:
      ...
      imageAlt:
        'Screenshot aplikácie Track My Bunny – sledovanie zdravia a hmotnosti domácich králikov',
      screenshots: [
        {
    ...
    },
    {
      ...
      type: 'Web',
      description:
        'Vzdelávacia aplikácia pre deti v predškolskom veku, ktorá využíva umelú inteligenciu na generovanie interaktívnych úloh. Rozvíja predčitateľskú gramotnosť, počítanie a logické myslenie formou hry prispôsobenej tempu každého dieťaťa.',
      longDescription:
    ...
    },
    {
      ...
      type: 'Web',
      description:
        'Generátor pexesa z vlastných obrázkov. Nahrajte ľubovoľné fotografie a aplikácia s pomocou umelej inteligencie automaticky vytvorí pamäťovú hru – ideálne pre učiteľov, rodičov a deti.',
      longDescription:
    ...
    },
    {
      ...
      type: 'Web',
      description:
        'Laboratórium na bezpečné a legálne trénovanie útočných techník SQL Injection. Obsahuje sériu úrovní s realistickými scenármi, vysvetleniami zraniteľností a radami na obranu – vhodné pre študentov aj profesionálov.',
      longDescription:
    ...
    },
    {
      ...
      type: 'Web',
      description:
        'Svadobná stránka s informáciami pre hostí, harmonogramom dňa a možnosťou nahrávania a zdieľania fotografií. Vytvorená na mieru ako darček pre novomanželov.',
      longDescription:
      ...
      imageAlt:
        'Screenshot svadobnej stránky Mirka a Dávid – informácie pre hostí a galéria fotografií',
      screenshots: [
        {
    ...
    },
    {
      ...
      type: 'Web',
      description:
        'Voľne dostupné nástroje na predikciu fototoxicity a genotoxicity látok pomocou strojového učenia. Vyvinuté v rámci výskumného projektu na FIIT STU v spolupráci s výskumným tímom.',
      longDescription:
      ...
      imageAlt:
        'Screenshot nástroja Toxipred na predikciu genotoxicity látok pomocou strojového učenia',
      screenshots: [
        {
  ...
  en: [
    {
      ...
      type: 'Web',
      description:
        'A health management app for pet rabbits. Daily logs, weight trend monitoring, medication scheduling, and vet visit records with PDF export.',
      longDescription:
      ...
      image: '/images/trackmybunny.jpg',
      imageAlt:
        'Screenshot of Track My Bunny app – pet rabbit health and weight tracking dashboard',
      screenshots: [
        {
          src: '/images/trackmybunny.jpg',
    ...
    },
    {
      ...
      type: 'Web',
      description:
        "Educational application for preschool-aged children that uses AI to generate interactive exercises. It develops early literacy, counting and logical thinking through play, adapting to each child's own pace.",
      longDescription:
    ...
    },
    {
      ...
      type: 'Web',
      description:
        'Memory card game generator from your own images. Upload any photos and the app automatically creates a custom memory game using AI – ideal for teachers, parents and children.',
      longDescription:
    ...
    },
    {
      ...
      type: 'Web',
      description:
        'A safe and legal laboratory for practising SQL Injection attack techniques. Features multiple levels with realistic scenarios, vulnerability explanations and defence tips – suitable for students and professionals alike.',
      longDescription:
    ...
    },
    {
      ...
      type: 'Web',
      description:
        'Wedding website with guest information, day schedule, and photo uploading and sharing. Built as a custom gift for the newlyweds.',
      longDescription:
    ...
    },
    {
      ...
      type: 'Web',
      description:
        'Team page for the TP CUP competition at FIIT STU. The project goal was to build a machine learning model for detecting genotoxicity of chemical substances.',
      longDescription:
      ...
      image: '/images/toxipred_team.png',
      imageAlt:
        'Screenshot of Toxipred team page for the TP CUP competition at FIIT STU Bratislava',
      screenshots: [
        {
          src: '/images/toxipred_team.png',
